...
const { SET_PRODUCTS, SET_ADD_TO_CART, SET_CART_ITEM_DECREMENT, SET_CART_ITEM_INCREMENT, SET_CART_ITEM_DELETE, SET_CART_ITEM_CHECK , SET_CART_ITEM_DELIVERY, SET_CART_ITEM_PICKUP, SET_ADDRESS_ID} = require('./types').default;
